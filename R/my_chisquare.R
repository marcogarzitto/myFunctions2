...
#'
#' @param a Factor vector. Dependent/Group variable (using wide format for data-frame). Default: None.
#' @param b Factor vector. Independent/Group variable (using wide format for data-frame). Default: None.
